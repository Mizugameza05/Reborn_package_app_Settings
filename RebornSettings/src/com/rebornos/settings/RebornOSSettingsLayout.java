/*
 * Copyright (C) 2017-2020 RebornOS Android Project
 *
...
import com.rebornos.settings.fragments.About;
import com.rebornos.settings.fragments.Buttons;
import com.rebornos.settings.fragments.LockScreen;
import com.rebornos.settings.fragments.Miscellaneous;
import com.rebornos.settings.fragments.Navigation;
import com.rebornos.settings.fragments.Notifications;
import com.rebornos.settings.fragments.QuickSettings;
import com.rebornos.settings.fragments.Sound;
import com.rebornos.settings.fragments.StatusBar;
import com.rebornos.settings.fragments.UserInterface;
/*
import com.rebornos.settings.fragments.Recents;
*/

public class RebornOSSettingsLayout extends SettingsPreferenceFragment {

    private static final String TAG = "RebornOSSettingsLayout";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.rebornos_settings_title);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mContainer = container;
        View view = inflater.inflate(R.layout.rebornos_settings, container, false);
...
*/
            ...
            getString(R.string.about_rebornos)
        };
        return titleString;
    }
